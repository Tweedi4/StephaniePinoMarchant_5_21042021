//Appel API via fetch pour récupérer toutes les données des articles
fetch('http://localhost:3000/api/teddies')
  ...
  .then((response) => {
    ...
    for(let i = 0; i < response.length; i++) {
      ...
      <p class="row" style="overflow:hidden;"><img src="${response[i].imageUrl}" alt="Images ours" style= "width:28rem; border-radius:5px;"></p>
