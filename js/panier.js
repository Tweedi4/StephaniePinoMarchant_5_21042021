...
// variable quantité 0
let total = 0;
// Appel ma fonction affichage panier
displayQuantity()

// Contenu panier, boutons de suppression et d'annulation panier ainsi que du formulaire de contact 
            ...
            `<h2 style="margin-top:30px;">Veuillez remplir le formulaire ci-dessous avant de valider votre commande</h2>
                <form class="contact__form" action="post" type="submit">
                    <div class="details__form">
                        ...
                        <input type="text" name="firstname" id="firstname" placeholder="Lucas" maxlength="25" pattern="[a-zA-ZÀ-ÿ]{2,}" required />
                    </div>
                    <div class="details__form">
                    ...
                    <div class="details__form">
                        ...
                        <input type="text" name="address" id="address" placeholder="33 rue du muguet" maxlength="50" required />
                    </div>
                    <div class="details__form">
                        <label for="city">VILLE</label>
                        <input type="text" name="city" id="city" placeholder="Bordeaux" maxlength="50" pattern="[A-Za-z]{2,}" required />
                    </div>
                    <div class="details__form">
...
//Requête POST, envoi au serveur "contact" et le tableau id "produits"
